	...
	<div class="row">
    	<div class=" col-md-2 sidebar">
    	  ...
    	  <div class="table-responsive ">
            ...
            <?php if(is_array($admin_users)): $i = 0; $__LIST__ = $admin_users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
    	        ...
    	        <td><?php echo ($d["regtime"]); ?></td>
    	        <td><a href="/KCSJ/index.php/Admin/Admin/edit/id/<?php echo ($d["id"]); ?>">修改</a> <a href="/KCSJ/index.php/Admin/Admin/del/id/<?php echo ($d["id"]); ?>">删除</a></td>
