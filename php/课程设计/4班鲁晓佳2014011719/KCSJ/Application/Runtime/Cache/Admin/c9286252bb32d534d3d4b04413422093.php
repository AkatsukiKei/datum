    	  ...
    	  <div class="table-responsive ">
    	    ...
    	    <div class="list-group ">
    	      <div class="list-group-item">
    	        <form role="form" method="post" action="/KCSJ/index.php/Admin/Admin/doRepwd">
              <?php if(is_array($admin_users)): $i = 0; $__LIST__ = $admin_users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><div class="input-group"> <span class="input-group-addon">用户名：</span>
    	            <input type="text" class="form-control" value="<?php echo ($d["username"]); ?>" readonly name="username">
  	            </div>
    	          <div class="input-group "> <span class="input-group-addon" for="inputWarning1">真实姓名：</span>
    	            <input type="text" class="form-control" value="<?php echo ($d["realname"]); ?>" id="input" readonly name="realname">
  	            </div>
    	          ...
    	          <div class="input-group"> <span class="input-group-addon">确认新密码：</span>
    	            <input type="password" class="form-control" placeholder="" name="repwd">
  	            </div>
