	...
	<div class="row">
    	<div class=" col-md-2 sidebar">
    	  ...
    	  <div class="list-group form">
    	    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" action="/KCSJ/index.php/Admin/News/doEdit">
          <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><div class="list-group-item">
    	        <label for="inputEmail3" class="col-sm-2 control-label">新闻标题</label>
    	        <div class="col-sm-10">
    	          <input type="input" class="form-control" id="inputEmail3" name="title" placeholder="" value="<?php echo ($d["title"]); ?>">
  	          </div>
  	        </div>
    	      <div class="list-group-item">
    	        <label for="inputEmail3" class="col-sm-2 control-label">发布时间</label>
    	        <div class="col-sm-10"><input type="input" class="form-control" name="posttime" id="inputEmail3"  value="<?php echo ($d["posttime"]); ?>" readonly ></div>
  	        </div>
    	     
    	      <div class="list-group-item">
    	        <label for="inputEmail3" class="col-sm-2 control-label">发布人/作者</label>
    	        <div class="col-sm-10">
    	          <input type="input" class="form-control" id="inputEmail3" name="author" value="<?php echo ($d["author"]); ?>" >
  	          </div>
  	        </div>
    	      ...
    	      <div class="list-group-item">
               <label for="inputEmail3" class="col-sm-2 control-label">内容</label>
    	        <div class="col-sm-10">
    	          ...
    	          <textarea id="editor_id" name="content" style="width:90%;height:300px;"><?php echo ($d["content"]); ?></textarea>
    	        </div>
  	        </div>
