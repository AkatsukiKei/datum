	...
	<div class="row">
    	<div class=" col-md-2 sidebar">
    	  ...
    	  <div class="table-responsive ">
            ...
            <?php if(is_array($books)): $i = 0; $__LIST__ = $books;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
    	        <td><input type="checkbox" name="checkbox" id="checkbox">
    	          </td>
    	        <td><?php echo ($d["title"]); ?></td>
    	        <td><?php echo ($d["author"]); ?></td>
    	        <td><?php echo ($d["publisher"]); ?></td>
    	        <td><?php echo ($d["publishdate"]); ?></td>
    	        <td><?php echo ($d["isbn"]); ?></td>
    	        <td><?php echo ($d["issn"]); ?></td>
    	        <td><a href="/KCSJ/index.php/Admin/Book/edit/id/<?php echo ($d["id"]); ?>">修改</a><a href="#"></a> <a href="/KCSJ/index.php/Admin/Book/del/id/<?php echo ($d["id"]); ?>">删除</a></td>
