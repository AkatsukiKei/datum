...
<head>
    ...
    <title>联系方式 - 北京国际数学研究中心数学数字化图书馆</title>
...
<body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/KCSJ/index.php/Home/Index/contact"><i class="fa fa-envelope fa-lg"></i> 联系方式</a></li>
    ...
    <div class="jumbotron map-frame map-wall">
        <div id="map"></div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="media articlelist-item">
                    <div class="media-body">
                        ...
                        <div class="article-content-full" id="contact">
            ...
            <div class="col-md-6 media-wall">

                <div class="img-frame" style="margin:40px 0 20px 10px;">
                    <div class="hover-effect-container">
                        <img src="/KCSJ/Public/front/images/building.jpg" alt="" class="img-responsive hover-effect-image"/>
                    </div>    
                </div>
...
<script type="text/javascript">
    ...
    function init() {
        ...
        var mapOptions = {
            ...
            center: new google.maps.LatLng(39.99697457703154, 116.30702823400497), // BICMR Library

            // How you would like to style the map. 
            // This is where you would paste any style found on Snazzy Maps.
            styles: [{ "stylers": [{ "hue": "#3D4548" }, { "saturation": 54 }] }, { "featureType": "water", "stylers": [{ "color": "#ffffff" }] }, { "featureType": "administrative.country", "elementType": "labels", "stylers": [{ "visibility": "off" }] }]
        };
        ...
        var myLatlng = new google.maps.LatLng(39.99597457703154, 116.30702823400497);

        var infowindow = new google.maps.InfoWindow({
            content: "<div class='left'><b>北京国际数学研究中心<br />数学数字化图书馆</b></div>"
        });
