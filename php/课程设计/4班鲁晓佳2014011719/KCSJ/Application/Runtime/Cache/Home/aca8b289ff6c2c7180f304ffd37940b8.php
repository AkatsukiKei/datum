...
<body>
    ...
    ﻿    <div class="container">
        ...
        <div class="row">
            ...
            <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i; $id = $d['id']; welcome($id); ?>
 ...
 $date = $d["posttime"]; $year = substr($date,0,4); $month = substr($date,5,2); $day = substr($date,8); echo "<span class='pubdate-day text-center'>".$day."</span><span class='pubdate-year-mon text-center'>".$year."年".$month."月</span>"; ?>
                    ...
                    <div class="media-body">
                         <h4 class="article-heading"><?php echo ($d["title"]); ?></h4>
                ...
                <div class="col-md-6 article-pager article-prev">
                    <!-- 如无前一篇则可不显示下面内容 -->
                    <span class="article-arrow"><i class="fa fa-chevron-left"></i> 上一篇</span>
                    <span class="article-link">
                        <a href="/KCSJ/index.php/Home/News/detail/id/<?php proId($id);?>"><?php proTitle($id);?></a>
                    </span>
                    <!--  -->
                </div>
                <div class="col-md-6 article-pager article-next">
                    <!-- 如无后一篇则可不显示下面内容 -->
                    <span class="article-arrow">下一篇 <i class="fa fa-chevron-right"></i></span>
                    <span class="article-link">
                        <a href="/KCSJ/index.php/Home/News/detail/id/<?php nextId($id);?>"><?php nextTitle($id);?></a>
                    </span>
                    <!--  -->
